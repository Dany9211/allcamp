...
if "home_team" in df.columns:
    home_teams = ["Tutte"] + sorted(df[df["league"] == selected_league]["home_team"].dropna().unique()) if selected_league != "Tutte" else ["Tutte"] + sorted(df["home_team"].dropna().unique())
...
if "away_team" in df.columns:
    away_teams = ["Tutte"] + sorted(df[df["league"] == selected_league]["away_team"].dropna().unique()) if selected_league != "Tutte" else ["Tutte"] + sorted(df["away_team"].dropna().unique())
...
# --- Distribuzione Gol ogni 5 minuti (0-90+) ---
